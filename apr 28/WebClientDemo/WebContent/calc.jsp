...
<body>
	<%
		...
		b=Integer.parseInt(request.getParameter("secondNo"));
		 URL url = new URL("http://localhost:8181/CalcServiceDemo/webapi/calc/Sum/" +a+"/"+b);
	        ...
	        URL url1 = new URL("http://localhost:8181/CalcServiceDemo/webapi/calc/Sub/" +a+"/"+b);
	        ...
	        URL url2 = new URL("http://localhost:8181/CalcServiceDemo/webapi/calc/Mult/" +a+"/"+b);
