...
public class EmployDaoServiceLocator extends org.apache.axis.client.Service implements com.java.hib.EmployDaoService {
    ...
    private java.lang.String EmployDao_address = "http://localhost:8080/HibServiceExample/services/EmployDao";
    ...
    public com.java.hib.EmployDao getEmployDao(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.java.hib.EmployDaoSoapBindingStub _stub = new com.java.hib.EmployDaoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.java.hib.EmployDao.class.isAssignableFrom(serviceEndpointInterface)) {
                com.java.hib.EmployDaoSoapBindingStub _stub = new com.java.hib.EmployDaoSoapBindingStub(new java.net.URL(EmployDao_address), this);
                _stub.setPortName(getEmployDaoWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://hib.java.com", "EmployDaoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://hib.java.com", "EmployDao"));
        }
